...
public class BaseService extends MasterService {
	...
	public static List<Map> importOrder(String fileId, String fileName, String userId, String name, String email,
		...
		List<Map> result = excuteQuery(IMPORT_ORDER,
				new Object[] { fileId, fileName, userId, name, email, financialStatus, create_at, lineitemQuantity,
	...
	public static Map insertDropshipOrder(String id, String note, String currency, Date createAt) throws SQLException{
		Map result = searchOne(INSERT_DROPSHIP_ORDER, new Object[] {id, note, currency, createAt});
		return result;
	}
	...
	public static Map insertDropshipOrderProduct(String id, String baseId, String colorId, String colorValue,
			...
			String variantName, String currency, String unitAmount, int quantity, Date createAt)
			throws SQLException {
		Map result = searchOne(INSERT_DROPSHIP_ORDER_PRODUCT,
				new Object[] { id, baseId, colorId, colorValue, sizeId, price, url, designBackUrl, mockupFrontUrl,
						mockupBackUrl, variantName, currency, unitAmount, quantity, createAt });
		return result;
	}

	public static Map insertShipping(String shippingId, String email, String createAt, String shippingName,
		...
		Map result = searchOne(INSERT_SHIPPING, new Object[] { shippingId, email, createAt, shippingName,
