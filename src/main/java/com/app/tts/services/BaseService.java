...
public class BaseService extends MasterService {
	...
	public static final String GET_FILE = "{call PKG_IMPORT_ORDER.get_file(?,?,?)}";
	public static final String UPDATE_STATE_FILE = "{call PKG_IMPORT_ORDER.update_state_file(?,?,?,?)}";

	public static List<Map> importOrder(String fileId, String fileName, String userId, String order_id, String name,
			String email, String financialStatus, Date create_at, String lineitemQuantity, String lineitemName,
			String lineitemSku, String shippingName, String shippingStreet, String shippingAddress1,
			String shippingAddress2, String shippingCompany, String shippingCity, String shippingZip,
			String shippingProvince, String shippingCountry, String shippingPhone, String shippingMethod, String notes,
			String id, String designFrontUrl, String designBackUrl, String mockupFrontUrl, String mockupBackUrl,
			String checkValidAddress, String currency, String unitAmount, String location, String state,
			String groupColumn) throws SQLException {

		List<Map> result = excuteQuery(IMPORT_ORDER,
				new Object[] { fileId, fileName, userId, order_id, name, email, financialStatus, create_at,
						lineitemQuantity, lineitemName, lineitemSku, shippingName, shippingStreet, shippingAddress1,
						shippingAddress2, shippingCompany, shippingCity, shippingZip, shippingProvince, shippingCountry,
						shippingPhone, shippingMethod, notes, id, designFrontUrl, designBackUrl, mockupFrontUrl,
						mockupBackUrl, checkValidAddress, currency, unitAmount, location, state, groupColumn });
		return result;
	}
	...
	public static Map insertDropshipOrderProduct(String id, String baseId, String colorId, String colorValue,
			...
			String variantName, String currency, String unitAmount, int quantity) throws SQLException {
	...
	public static Map insertShipping(String shippingId, String email, String shippingName, String shippingAddress1,
			String shippingAddress2, String shippingCountry, String shipingPhone, String shippingZip)
			throws SQLException {
		Map result = searchOne(INSERT_SHIPPING, new Object[] { shippingId, email, shippingName, shippingAddress1,
				shippingAddress2, shippingCountry, shipingPhone, shippingZip });
		return result;
	}
	...
	public static Map getFile() throws SQLException {
		Map result = searchOne(GET_FILE, new Object[] {});
		return result;
	}
	
	public static Map updateStateFile(String id) throws SQLException{
		Map result = searchOne(UPDATE_STATE_FILE, new Object[] {id});
		return result;
	}
