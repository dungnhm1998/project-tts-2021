...
public class SubService extends MasterService{
	...
	public static Map createProduct (String campaignResult_id, String baseId, String colorId,
		...
		Map result = searchOne(CREATE_PRODUCT, new Object[] {campaignResult_id, baseId, colorId,
	...
	public static Map format1(Map result) throws SQLException{
		Map campaignResult = new LinkedHashMap<>();

		campaignResult.put(AppParams.ID, ParamUtil.getString(result , AppParams.S_ID));
		campaignResult.put(AppParams.USER_ID, ParamUtil.getString(result , AppParams.S_USER_ID));
		campaignResult.put(AppParams.TITLE, ParamUtil.getString(result , AppParams.S_TITLE));
		campaignResult.put(AppParams.DESC, ParamUtil.getString(result , AppParams.S_DESC));
		campaignResult.put(AppParams.CATEGORY_IDS, ParamUtil.getString(result , AppParams.S_CATEGORY_IDS));
		campaignResult.put(AppParams.TAGS, ParamUtil.getString(result , AppParams.S_TAGS));
		campaignResult.put(AppParams.START, ParamUtil.getString(result , AppParams.D_START));
		campaignResult.put(AppParams.END, ParamUtil.getString(result , AppParams.D_END));
		campaignResult.put(AppParams.RELAUNCH, ParamUtil.getString(result , AppParams.N_AUTO_RELAUNCH));
		campaignResult.put(AppParams.PRIVATE, ParamUtil.getString(result , AppParams.N_PRIVATE));
		campaignResult.put(AppParams.FB_PIXEL, ParamUtil.getString(result , AppParams.S_FB_PIXEL));
		campaignResult.put(AppParams.GG_PIXEL, ParamUtil.getString(result , AppParams.S_GG_PIXEL));
		campaignResult.put(AppParams.CREATE, ParamUtil.getString(result , AppParams.D_CREATE));
		campaignResult.put(AppParams.UPDATE, ParamUtil.getString(result , AppParams.D_UPDATE));
		campaignResult.put(AppParams.STATE, ParamUtil.getString(result , AppParams.S_STATE));
		campaignResult.put(AppParams.LENGTH, ParamUtil.getString(result , AppParams.N_LENGTH));
		campaignResult.put(AppParams.SALE_PRICE, ParamUtil.getString(result , AppParams.S_SALE_PRICE));
		campaignResult.put(AppParams.FAVORITE, ParamUtil.getString(result , AppParams.N_FAVORITE));
		campaignResult.put(AppParams.ARCHIVED, ParamUtil.getString(result , AppParams.N_ARCHIVED));
		campaignResult.put(AppParams.DESIGN_FRONT_URL, ParamUtil.getString(result , AppParams.S_DESIGN_FRONT_URL));
		campaignResult.put(AppParams.DESIGN_BACK_URL, ParamUtil.getString(result , AppParams.S_DESIGN_BACK_URL));
		campaignResult.put(AppParams.DOMAIN_ID, ParamUtil.getString(result , AppParams.S_DOMAIN_ID));
		campaignResult.put(AppParams.DOMAIN, ParamUtil.getString(result , AppParams.S_DOMAIN));
		campaignResult.put(AppParams.ART_IDS, ParamUtil.getString(result , AppParams.S_ART_IDS));
		campaignResult.put(AppParams.BASE_GROUP_ID, ParamUtil.getString(result , AppParams.S_BASE_GROUP_ID));
		campaignResult.put(AppParams.BACK_VIEW, ParamUtil.getString(result , AppParams.N_BACK_VIEW));
		campaignResult.put(AppParams.AS_TM, ParamUtil.getString(result , AppParams.N_AS_TM));
		campaignResult.put(AppParams.AD_TAGS, ParamUtil.getString(result , AppParams.S_AD_TAGS));
		campaignResult.put(AppParams.SEO_TITLE, ParamUtil.getString(result , AppParams.S_SEO_TITLE));
		campaignResult.put(AppParams.SEO_DESC, ParamUtil.getString(result , AppParams.S_SEO_DESC));
		campaignResult.put(AppParams.SEO_IMAGE_COVER, ParamUtil.getString(result , AppParams.S_SEO_IMAGE_COVER));
		campaignResult.put(AppParams.DESIGN_CHECK, ParamUtil.getString(result , AppParams.N_DESIGN_CHECK));
		campaignResult.put(AppParams.DESIGN_VERSION, ParamUtil.getString(result , AppParams.S_DESIGN_VERSION));
		campaignResult.put(AppParams.LEFT_CHEST, ParamUtil.getString(result , AppParams.N_LEFT_CHEST));
		campaignResult.put(AppParams.SUB_STATE, ParamUtil.getString(result , AppParams.S_SUB_STATE));
		campaignResult.put(AppParams.MODIFIED_AT, ParamUtil.getString(result , "MODIFIED_AT"));
		campaignResult.put(AppParams.OLD_TAGS, ParamUtil.getString(result , AppParams.OLD_TAGS));
