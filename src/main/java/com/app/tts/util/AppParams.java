...
public class AppParams {
	...
	public static final String REFERENCE_ORDER = "reference_order";
	public static final String S_REFERENCE_ORDER = "S_REFERENCE_ORDER";
	public static final String TOTAL_ITEM = "total_item";
	public static final String N_TOTAL_ITEM = "N_TOTAL_ITEM";
	public static final String FULFILLED_ITEM = "fulfilled_item";
	public static final String N_FULFILLED_ITEM = "N_FULFILLED_ITEM";
	public static final String REFUNDED_ITEM = "refunded_item";
	public static final String N_REFUNDED_ITEM = "N_REFUNDED_ITEM";
	public static final String ACCOUNTING_PROCESSED = "accounting_processed";
	public static final String N_ACCOUNTING_PROCESSED = "N_ACCOUNTING_PROCESSED";
	public static final String PAYMENT_FEE = "payment_fee";
	public static final String S_PAYMENT_FEE = "S_PAYMENT_FEE";
	public static final String REQUIRE_REFUND = "require_refund";
	public static final String N_REQUIRE_REFUND = "N_REQUIRE_REFUND";
	public static final String REFUND_NOTE = "refund_note";
	public static final String S_REFUND_NOTE = "S_REFUND_NOTE";
	public static final String D_REQUIRE_REFUND = "D_REQUIRE_REFUND";
	public static final String HAS_ADJUST = "has_adjust";
	public static final String N_HAS_ADJUST = "N_HAS_ADJUST";
	public static final String ADJUST_NOTE = "adjust_note";
	public static final String S_ADJUST_NOTE = "S_ADJUST_NOTE";
	public static final String REFUNDED_AMOUNT = "refunded_amount";
	public static final String S_REFUNDED_AMOUNT = "S_REFUNDED_AMOUNT";
	public static final String REF_FEE = "ref_fee";
	public static final String S_REF_FEE = "S_REF_FEE";
	...
	public static final String MINIFIED_JSON = "minified_json";
	public static final String S_MINIFIED_JSON = "S_MINIFIED_JSON";
	public static final String D_ACCOUNTING_PROCESSED = "D_ACCOUNTING_PROCESSED";
	public static final String SELLER_COST = "seller_cost";
	public static final String S_SELLER_COST = "S_SELLER_COST";
	public static final String PRODUCE_COST = "produce_cost";
	public static final String S_PRODUCE_COST = "S_PRODUCE_COST";
	public static final String SHIPPING_COST = "shipping_cost";
	public static final String S_SHIPPING_COST = "S_SHIPPING_COST";
	public static final String SOURCE = "source";
	public static final String S_SOURCE = "S_SOURCE";
	public static final String ORIGINAL_ID = "original_id";
	public static final String S_ORIGINAL_ID = "S_ORIGINAL_ID";
	public static final String EXTRA_FEE = "shipping_cost";
	...
	public static final String S_UNIT_AMOUNT = "S_UNIT_AMOUNT";
	public static final String UNIT_AMOUNT = "unit_amount";
	public static final String N_REFUND_ITEM = "N_REFUND_ITEM";
	public static final String REFUND_ITEM = "refund_item";
	public static final String S_PRINT_DETAIL = "S_PRINT_DETAIL";
	public static final String S_ITEM_TYPE = "S_ITEM_TYPE";
	public static final String S_PARTNER_PROPERTIES = "S_PARTNER_PROPERTIES";
	public static final String S_PARTNER_OPTION = "S_PARTNER_OPTION";
	public static final String S_CUSTOM_DATA = "S_CUSTOM_DATA";
	public static final String PRINT_DETAIL = "print_detail";
